...
{
    [CustomEditor(typeof(EasyLocomotionGroup))]
    public class EasyLocomotionGroupEditor : Editor
    {
        bool standFold = true, crouchFold = true, proneFold = true, jumpFold = true, otherFold = true;
        bool standTrackingFold = false, crouchTrackingFold = false, proneTrackingFold = false;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (standFold)
            {
                ...
                {
                    SerializedProperty blendtree = serializedObject.FindProperty("standBlendTree");
                    if (GUILayout.Button(Lang.Default))
                    {
                        blendtree.objectReferenceValue = VRCAssets.standBlendTree;
                    }
                    blendtree.objectReferenceValue = EditorGUILayout.ObjectField(Lang.BlendTree, blendtree.objectReferenceValue, typeof(BlendTree), true);
                }
                GUILayout.BeginHorizontal();
                GUILayout.Space(20);
                GUILayout.BeginVertical();
                standTrackingFold = EditorGUILayout.Foldout(standTrackingFold, Lang.TrackingControl);
                if (standTrackingFold)
                {
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("standTracking"), GUIContent.none);
                }
                GUILayout.EndVertical();
                GUILayout.Space(20);
                GUILayout.EndHorizontal();
            ...
            if (crouchFold)
            {
                ...
                else
                {
                    ...
                    SerializedProperty blendtree = serializedObject.FindProperty("crouchBlendTree");
                    if (GUILayout.Button(Lang.Default))
                    {
                        blendtree.objectReferenceValue = VRCAssets.crouchBlendTree;
                    }
                    blendtree.objectReferenceValue = EditorGUILayout.ObjectField(Lang.BlendTree, blendtree.objectReferenceValue, typeof(BlendTree), true);
                }
                ...
                GUILayout.Space(20);
                GUILayout.BeginVertical();
                crouchTrackingFold = EditorGUILayout.Foldout(crouchTrackingFold, Lang.TrackingControl);
                if (crouchTrackingFold)
                {
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("crouchTracking"), GUIContent.none);
                }
                GUILayout.EndVertical();
                GUILayout.Space(20);
                GUILayout.EndHorizontal();
            ...
            if (proneFold)
            {
                ...
                {
                    SerializedProperty blendtree = serializedObject.FindProperty("proneBlendTree");
                    if (GUILayout.Button(Lang.Default))
                    {
                        blendtree.objectReferenceValue = VRCAssets.proneBlendTree;
                    }
                    blendtree.objectReferenceValue = EditorGUILayout.ObjectField(Lang.BlendTree, blendtree.objectReferenceValue, typeof(BlendTree), true);
                }
                ...
                GUILayout.Space(20);
                GUILayout.BeginVertical();
                proneTrackingFold = EditorGUILayout.Foldout(proneTrackingFold, Lang.TrackingControl);
                if (proneTrackingFold)
                {
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("proneTracking"), GUIContent.none);
                }
                GUILayout.EndVertical();
                GUILayout.Space(20);
                GUILayout.EndHorizontal();
            ...
            EditorGUILayout.HelpBox(Lang.LocomotionTrackingNote, MessageType.Info);
            EditorGUILayout.HelpBox(Lang.LocomotionVersionNote, MessageType.Info);
        ...
        public void LocomotionFieldHeader()
        {
            ...
            EditorGUILayout.LabelField(new GUIContent(Lang.AnimClip, Lang.AnimClip),GUILayout.MinWidth(20));
