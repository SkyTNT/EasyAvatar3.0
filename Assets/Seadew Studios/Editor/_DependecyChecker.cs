...
namespace SeadewStudios
{
    ...
    public class _DependecyChecker
    {
        ...
        public static void Check()
        {
            ...
            Type toolsType = GetType("SeadewStudiosToolKit");
            var toolScriptPath = Directory.GetFiles(Application.dataPath, "Seadew Studios Tool Kit Menu.cs", SearchOption.AllDirectories);
